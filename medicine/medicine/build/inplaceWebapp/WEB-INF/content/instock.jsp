		...
		<form id="form" method="post">
			<div style="margin-left: 30px">
				<div style="diapaly: inline">
					 ...
					 <input id="medicine" required="true" data-options="required:true,missingMessage:'请选择药品',editable:false"  style="height: 25px" name="medicine"> 
					 <label style="padding-right: 25px">采购人员：</label>
					 <input id="person" required="true" data-options="required:true,missingMessage:'请选择采购人员',editable:false"  style="height: 25px" name="person"> 
					 <br/><br/>
					 ...
					 <input name="medicineNumber" style="height:20px" class="easyui-numberbox" precision="0"> 
					  <br/><br/>
					 ...
					 <input name="medicineTotalPrice" style="height:20px" class="easyui-numberbox" precision="2"> 
